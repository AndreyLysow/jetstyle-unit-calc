    ...
    <div className={s.formula}>
      ...
      <div className={`${s.group} ${s.left}`}>
        <div className={s.inputsLeft}>
          <label className={s.box}>
            ...
            <input value={v.cpc} onChange={onChange("cpc")} className={s.input} />
          </label>
          <span className={s.sep}>/</span>
          <label className={s.box}>
            <span className={s.label}>CR1, %</span>
            <input value={v.cr1} onChange={onChange("cr1")} className={s.input} />
          </label>
          <span className={s.sep}>/</span>
          <label className={s.box}>
            <span className={s.label}>CR2, %</span>
            <input value={v.cr2} onChange={onChange("cr2")} className={s.input} />
          </label>
        </div>
      ...
      <div className={s.midCombo}>
        <div className={`${s.group} ${s.mid}`}>
          <div className={s.inputsMid}>
            <label className={s.box}>
              ...
              <input value={v.avp} onChange={onChange("avp")} className={s.input} />
            </label>
            <span className={s.innerOp}>−</span>
            <label className={s.box}>
              <span className={s.label}>COGS, ₽</span>
              <input value={v.cogs} onChange={onChange("cogs")} className={s.input} />
            </label>
          </div>
        ...
        <div className={`${s.group} ${s.ret}`}>
          <label className={s.box}>
            ...
            <input value={v.ret} onChange={onChange("ret")} className={s.input} />
          </label>
        </div>
      </div>
      ...
      <div className={s.pppuRow}>
        ...
        <div className={s.pppu}>
          ...
          <div className={s.pppuValue}>{format(pppu)}</div>
        </div>
      </div>

      <label className={s.au}>
        <span className={s.label}>AU</span>
        <input value={v.au} onChange={onChange("au")} className={s.input} />
